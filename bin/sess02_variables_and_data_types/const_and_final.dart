...
void main()
{
  ...
  final studentAttendance = [
    'Edmund', 'Keagan','Cyrus', "Cyrus","Sifa","Ayan",
    "Fardowsa","Dennis","Theodora", 'Shamim', 'Shion',
    'Lavender', 'Victor', "Safia",
  ];
  print("Current students in class are:"
      "\n$studentAttendance");
  // The studentAttendance variable cannot point to another list but
  ...
  // The fruit list reference nor its contents (fruits) cannot change

  // Uncommenting the line below causes an error
  //fruits = ["Guava",'Peach',"Banana", 'Pomegranate', 'Watermelon'];
